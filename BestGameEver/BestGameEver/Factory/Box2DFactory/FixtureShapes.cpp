...
b2Shape * CircleFixture::GetShape(b2Vec2 size, b2Vec2 center, float angle) {
...
b2Shape *  PolyFixture::GetShape(b2Vec2 size, b2Vec2 center, float angle) {
...
b2Shape * ChainFixture::GetShape(b2Vec2 size, b2Vec2 center, float angle) {
